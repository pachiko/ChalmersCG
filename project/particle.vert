...
void main()
{
	...
	// Particle is in world space. Want view space
	vec4 particle_vs = V * vec4(particle.xyz, 1.0);
	...
	float sz = scale_factor * mix(0.0, 5.0, pow(life, 1.0 / 4.0));
	gl_PointSize = clamp(sz, 30, 80);
}